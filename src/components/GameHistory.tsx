...
export function GameHistory({ sessions, onVerify }: GameHistoryProps) {
  ...
  // ⚡ Bolt: Memoize the filtering logic to prevent re-calculation on every render.
  // This is especially important when the parent component re-renders but the
  // sessions, filter, or searchTerm props haven't changed.
