...
export function GameHistory({ sessions, onVerify }: GameHistoryProps) {
  ...
  // Memoize the filtered sessions to prevent unnecessary re-calculations on every render.
  // The list is only re-filtered when the original sessions, filter, or search term change.
